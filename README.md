...
- local input hashing, Game Boy/Game Boy Advance ROM inspectors, deterministic ROM-bank fingerprinting, conservative GBA layout measurement, and artifact-policy validation tools;
